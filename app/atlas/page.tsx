...
export default function AtlasPage() {
  return <main>
    ...
    <section className="section shell"><div className="section-head"><div><p className="eyebrow">Market interpretation</p><h2>The Atlas is designed to show relationships, not just names.</h2></div><p className="section-copy">A robotics market is not only a list of manufacturers. It includes enabling components, AI research, integrators, operators, regional clusters and the commercial pathways that connect them. The Atlas helps suppliers, buyers and ecosystem partners see where a technology may need validation, integration, support or a different route to market.</p></div><div className="grid3"><article className="card"><span className="num">Signal</span><h3>Capability</h3><p>Which Canadian organizations create platforms, components, software, research or integration capacity?</p></article><article className="card"><span className="num">Signal</span><h3>Demand</h3><p>Which industries and operators have field conditions where robotics, drones or autonomous systems may produce measurable value?</p></article><article className="card"><span className="num">Signal</span><h3>Path</h3><p>Which partners are needed to move from product capability to a safe, supported and commercially credible deployment?</p></article></div></section>
