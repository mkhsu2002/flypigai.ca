...
export default function AtlasPage() {
  return <main>
    ...
    <section className="atlas-hero shell">
      ...
      <div className="atlas-stats"><div><strong>{atlasCategories.length}</strong><span>ecosystem categories</span></div><div><strong>{atlasCategories.reduce((sum, category) => sum + category.companies.length, 0)}</strong><span>organizations profiled</span></div><div><strong>Canada</strong><span>national market focus</span></div></div>
    </section>
    ...
    <section className="cta shell"><div className="cta-box"><div><p className="eyebrow">Contribute or connect</p><h2>Should your organization be included in the Atlas?</h2></div><div className="actions"><a className="pill primary" href="/contact">Contact us</a></div></div></section>
