...
export const metadata: Metadata = makeMetadata({
  title: "Physical AI Industries in Canada",
  description: "Explore Canadian industries adopting robotics, drones, automation and autonomous systems.",
  path: "/atlas/industries",
