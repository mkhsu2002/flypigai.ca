...
export const metadata: Metadata = makeMetadata({
  title: "Canadian Physical AI Clusters",
  description: "Explore Canada's regional robotics, drone, automation and AI clusters by province and region.",
  path: "/atlas/locations",
