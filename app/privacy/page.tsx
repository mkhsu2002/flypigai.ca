...
export default function PrivacyPage() {
  return <main>
    ...
    <section className="hero shell">
      ...
      <p className="lead">This notice explains how FlyPig AI handles information submitted through contact forms, Atlas corrections and business-development inquiries.</p>
    </section>
    ...
    <section className="section dark"><div className="shell"><div className="section-head"><div><p className="eyebrow">Retention and correction</p><h2>Keep early inquiries practical and minimal.</h2></div><p className="section-copy">FlyPig AI keeps inquiry information only as long as needed for business follow-up, editorial review or relationship management. To request correction or deletion of submitted information, contact FlyPig AI through the contact page.</p></div></div></section>
    <SiteFooter />
  </main>;
}
