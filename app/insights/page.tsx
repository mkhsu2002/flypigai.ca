...
export default function InsightsPage() {
  return <main>
    ...
    <section className="hero insights-hero"><div className="shell hero-grid"><div>
      ...
      <p className="lead">Evidence-led analysis of Canada's Physical AI ecosystem, deployment readiness, market structure and technology-selection questions. Insights support FlyPig AI's design-intelligence work and the Canada Physical AI Atlas.</p>
      <div className="actions"><a className="pill primary" href="/insights/physical-ai-modularization">Read the new research series</a><a className="pill secondary" href="/atlas">Explore the Atlas</a></div>
    ...
    <section className="section shell"><div className="section-head"><div><p className="eyebrow">Research series · New</p><h2>Physical AI Goes Modular.</h2></div><p className="section-copy">A six-part investigation into the coming Android moment of robotics: reference robot hardware, Physical AI operating layers, edge compute, Chinese platform supply chains, reusable robot skills and where value moves as the stack standardizes.</p></div><a className="feature-article" href="/insights/physical-ai-modularization"><div><span className="num">Series 01</span><h3>Physical AI Goes Modular: The Coming Android Moment of Robotics</h3><p>What happens when robot bodies, compute, middleware and physical skills become reusable building blocks—and which layers remain defensible?</p></div><span className="article-arrow">↗</span></a></section>
