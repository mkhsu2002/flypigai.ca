...
export default function ZhMethodologyPage() {
  ...
  return <main lang="zh-Hant">
    ...
    <section className="section dark"><div className="shell"><div className="section-head"><div><p className="eyebrow">商業關係揭露</p><h2>Atlas 收錄不代表存在合作關係。</h2></div><p className="section-copy">機構依公開資料與編輯研究收錄。被收錄不代表該機構是 FlyPig AI 的客戶、供應商、授權夥伴、代理對象或背書者；若未來存在與頁面判讀相關的商業、贊助或正式代理關係，將在相應頁面清楚標示。</p></div></div></section>
