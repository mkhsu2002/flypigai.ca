...
export const metadata: Metadata = makeMetadata({
  title: "關於 FlyPig AI",
  description: "FlyPig AI 是由創辦人主導、以溫哥華為基地的加拿大機器人市場開發與商業化服務團隊。",
  path: "/zh/about",
  enPath: "/about",
  zhPath: "/zh/about",
  locale: "zh_TW",
...
export default function ZhAboutPage() {
  return <main lang="zh-Hant">
    <SiteHeader locale="zh" languageHref="/about" />
    ...
    <section className="section dark"><div className="shell"><div className="section-head"><div><p className="eyebrow">公開研究子專案</p><h2>Canada Physical AI Atlas</h2></div><div><p className="section-copy">Atlas 是由 FlyPig AI 發起的市場研究與產業圖譜計畫，整理公司、技術、產業與地區的公開資訊。它不是政府官方名錄，也不代表對收錄機構的背書。</p><div className="actions"><a className="pill primary" href="/zh/atlas">探索 Atlas</a><a className="pill secondary" href="/zh/atlas/methodology">閱讀收錄方法</a></div></div></div></div></section>
