...
export default function ZhAboutPage() {
  return <main lang="zh-Hant"><JsonLd data={{ "@context": "https://schema.org", "@type": "AboutPage", "@id": `${siteUrl}/zh/about#page`, name: "關於 FlyPig AI", url: `${siteUrl}/zh/about`, mainEntity: { "@id": `${siteIdentity.founder.url}#person` }, isPartOf: { "@id": `${siteUrl}/#website` }, inLanguage: "zh-Hant" }} /><SiteHeader locale="zh" languageHref="/about" />
    <section className="hero shell about-hero"><p className="eyebrow">關於 FlyPig AI</p><h1>連結產品需求與技術能力的獨立情報層。</h1><p className="lead">FlyPig AI 聚焦加拿大產品與產業情境，以及台灣半導體、Edge AI、嵌入式運算、感測、機器人與製造能力。公開收錄不等同授權、背書或正式合作關係。</p></section>
