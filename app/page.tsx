...
export default function HomePage() {
  return <main>
    ...
    <section className="section dark"><div className="shell"><div className="section-head"><div><p className="eyebrow">How We Help</p><h2>Research can become a bounded commercial decision.</h2></div><p className="section-copy">Canadian product teams can qualify Taiwan technology routes. Taiwan technology companies can prepare for Canadian application and design-in conversations. Both paths produce a decision-ready brief before any introduction is considered.</p></div><div className="grid2"><article className="card"><span className="num">Canadian product teams</span><h3>Edge AI Technology Route &amp; Qualification</h3><p>Clarify requirements, compare architecture options and evaluate researched Taiwan technology candidates against fit, risk and open questions.</p><div className="actions"><a className="pill secondary" href="/services/canadian-product-teams">See the engagement</a></div></article><article className="card"><span className="num">Taiwan technology companies</span><h3>Canada Application &amp; Design-In Readiness</h3><p>Translate product capability into Canadian application context and identify the evidence needed for a credible technical conversation.</p><div className="actions"><a className="pill secondary" href="/services/taiwan-technology-companies">See the engagement</a></div></article></div></div></section>
