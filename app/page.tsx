...
const services = [
  ...
  ["02", "Partners and channels", "Connect with integrators, distributors, operators, research organizations and pilot customers."],
  ["03", "Representation", "Maintain local technical-commercial communication and follow through on selected opportunities."],
  ["04", "Sourcing and qualification", "Help Canadian organizations identify and assess relevant Asian robotics technologies and suppliers."],
];
...
export default function HomePage() {
  return <main>
    ...
    <div className="ticker">market development · local representation · partner discovery · supplier sourcing · pilot coordination · commercialization</div>
    ...
    <section className="section shell"><div className="section-head"><div><p className="eyebrow">Market guides</p><h2>Start with the right Canadian context.</h2></div><p className="section-copy">Read practical guides on Canadian robotics market entry, Physical AI ecosystem structure, integrator selection, drone and autonomous-systems demand, and cross-border commercialization.</p></div><div className="actions"><a className="pill secondary" href="/insights/canada-robotics-market-entry-guide">Canada market entry guide</a><a className="pill secondary" href="/insights/canada-physical-ai-ecosystem-overview">Physical AI ecosystem overview</a></div></section>
