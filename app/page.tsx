...
export default function HomePage() {
  return <main>
    <header className="shell nav">
      ...
      <nav className="navlinks"><a href="#capabilities">Capabilities</a><a href="#focus">Technology focus</a><a href="/insights">Insights</a><a href="#about">About</a></nav>
    ...
    <section id="capabilities" className="section shell">
      ...
      <div className="grid3">
        {capabilities.slice(0,3).map(([n,t,d])=><article className="card" key={t}><span className="num">{n}</span><h3>{t}</h3><p>{d}</p></article>)}
      </div>
    ...
    <section id="focus" className="section dark">
      <div className="shell">
    ...
    <section className="cta shell"><div className="cta-box"><div><p className="eyebrow">Canadian market development</p><h2>Looking for the right first opportunity in Canada?</h2></div><div className="actions"><a className="pill primary" href="mailto:hello@flypigai.ca?subject=Canadian Market Development">Start a conversation</a></div></div></section>
