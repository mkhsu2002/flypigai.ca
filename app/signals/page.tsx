...
export default function SignalsPage() {
  ...
  return <main>
    <JsonLd data={{
      ...
      "@type": "CollectionPage",
      "@id": `${siteUrl}/signals#collection`,
      name: "Taiwan Edge AI Industry Signals",
      ...
      mainEntity: {
        ...
        itemListElement: signals.map((signal, index) => ({
          "@type": "ListItem",
          position: index + 1,
          url: `${siteUrl}/signals/${signal.slug}`,
          name: signal.seoTitle,
        })),
      },
      inLanguage: "en-CA",
    }} />
    ...
    <section className="hero insights-hero"><div className="shell hero-grid"><div>
      ...
      <div className="actions"><a className="pill primary" href={featured ? `/signals/${featured.slug}` : "#latest"}>Read latest signal</a><a className="pill secondary" href="/Solutions">Taiwan Solutions</a><a className="pill secondary" href="/technologies">Technology Intelligence</a></div>
